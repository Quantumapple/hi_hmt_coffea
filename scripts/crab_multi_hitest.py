...
def createConfig(args, dataset):
    ...
    config.JobType.inputFiles = ['hitest_datset_runA.txt']
    #config.JobType.pyCfgParams = ['inputFiles=hitest_input.txt', 'runNumber=362321', 'maxEvents=-1']
    config.JobType.pyCfgParams = ['inputFiles=hitest_datset_runA.txt', 'maxEvents=-1']
